...
class OrderFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function loadOrderItemSubject(ObjectManager $manager): void
    {
        $subject0 = $this->getReference('subject-0', ProductVariant::class);
        $subject1 = $this->getReference('subject-1', ProductVariant::class);
        $subject2 = $this->getReference('subject-2', ProductVariant::class);
        ...
        $order1 = $this->orderRepository->createNew();
        $order1->addItem($this->orderItemRepository->createNew($subject0, 2));
        $order1->addItem($this->orderItemRepository->createNew($subject1, 2));

        $order2 = $this->orderRepository->createNew();
        $order2->addItem($this->orderItemRepository->createNew($subject0, 2));
